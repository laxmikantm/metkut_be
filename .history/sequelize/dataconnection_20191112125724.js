...
module.exports = new Sequelize('contacts', 'postgres', 'postgres', {
  ...
  host: 'http://localhost:5433/?key=73c61aaf-e798-46c0-a9cb-a444c7b65a06',
  dialect: 'postgres',
...
// module.exports = new Sequelize('postgres://postgres:postgres@localhost:5433/?key=73c61aaf-e798-46c0-a9cb-a444c7b65a06/contacts');
